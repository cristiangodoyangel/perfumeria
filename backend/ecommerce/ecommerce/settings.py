...
SECRET_KEY = 'django-insecure-gm0259k-q8e4^$*rj=2*!gf*h4#e&4-yi7p$)*ki14lxlr_sv!'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "Life Sex Shop Admin",
    ...
    "order_with_respect_to": ["Productos", "Categorias", "Carrito", "Usuarios","auth", "books", "books.author", "books.book"],
